# Guide d'installation de Linux Mint
### Société Tchadienne des Eaux (STE)

Document interne — Service informatique / SIG
Postes de travail x86 — Déploiement, configuration et maintenance de Linux Mint en environnement d'entreprise.

Distribution : Linux Mint 21.x LTS (Cinnamon) · Intégration Active Directory · Déploiement Clonezilla / Ansible · Supervision Zabbix.
...
- Fichier de configuration standardisé (voir section 8)
...
> **Important :** Ne jamais sauter cette étape en entreprise. Une ISO corrompue ou modifiée représente un risque de sécurité.
